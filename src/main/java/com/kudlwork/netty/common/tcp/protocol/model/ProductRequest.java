...
import com.kudlwork.netty.common.parser.annotation.FeatureType;
...
public class ProductRequest {
    ...
    @FixedLengthElement(seq = 1, maxLength = 5, padChar = '-')
    private Integer id;

    @FixedLengthElement(seq = 2, maxLength = 20)
    private BigDecimal prName;

    @FixedLengthElement(seq = 3, maxLength = 5, type = FeatureType.VARIABLE_COUNT)
